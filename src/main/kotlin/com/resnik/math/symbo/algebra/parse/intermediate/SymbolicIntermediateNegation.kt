...
class SymbolicIntermediateNegation(startIndex: Int, endIndex: Int, operation: SymbolicIntermediateOperation) : SymbolicIntermediateUnaryOperator(startIndex, endIndex, operation) {
